package com.example.ct.mysql;

import com.example.ct.util.ClassUtil;
            ...
            if (annotations.length > 0) {
                for (Annotation annotation : annotations) {
                    if (annotation instanceof MysqlTable) {
                        ...
                        // if (TableConstant.deviceTable != null)
                        // if (claz.getName().contains("SimInfo") && !TableConstant.simTable.isEmpty()) {
                        //     tableName = TableConstant.simTable;
                        // }
                        // if (claz.getName().contains("AndroidDevice") && !TableConstant.deviceTable.isEmpty()) {
                        //     tableName = TableConstant.deviceTable;
                        // }
                        // if (claz.getName().contains("AllocateDevice") && !TableConstant.migrateTable.isEmpty()) {
                        //     tableName = TableConstant.migrateTable;
                        // }
